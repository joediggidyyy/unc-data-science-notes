...
This repository is a learning resource. Be kind, be constructive, and assume good intent.

## Our standards

- Be respectful and welcoming.
- Provide constructive feedback.
- Don’t harass, demean, or insult others.

## Scope

These expectations apply in issues, pull requests, discussions, and any community spaces tied to this repository.

## Reporting

If someone is being a menace:

- Contact the maintainer (see `SUPPORT.md`).
