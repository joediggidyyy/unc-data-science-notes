...
| Field | Value |
| --- | --- |
| Document Title | main help |
| Domain / Scope | CLI |
| Artifact Type | Guide |
| Classification | Internal |
| Execution Window | 2025-11-26 |
| Operator / Author | ORACL-Prime |
| Location | CodeSentinel/docs/cli/main_help.md |
...
usage: python.exe C:\Users\joedi\AppData\Local\Programs\Python\Python314\Scripts\codesentinel
  ...
  {status,scan,maintenance,alert,schedule,update,clean,docs,integrate,setup,dev-audit,integrity} ...
...
positional arguments:
  {status,scan,maintenance,alert,schedule,update,clean,docs,integrate,setup,dev-audit,integrity}
    ...
    docs                Search and analyze documentation with intelligent matching
...
Examples:
  ...
  codesentinel docs find grant proposal         # Locate documentation mentioning grant proposals
