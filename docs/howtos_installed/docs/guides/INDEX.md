...
| Location | CodeSentinel/docs/guides/INDEX.md |
...
| `SHIP_MANIFEST_AUTOMATION_HELP.md` | Publication automation workflow | Release engineers | 10-15m |
...
- **Installation:** [`Guides README`](./README.md)
- **Architecture:** [`Architecture Index`](../architecture/INDEX.md)
- **Development:** [`Planning Index`](../planning/INDEX.md)
