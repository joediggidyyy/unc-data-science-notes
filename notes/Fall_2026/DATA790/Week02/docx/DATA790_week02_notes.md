...
<thead>
<tr>
<th colspan="5">Advanced Prompt Engineering Techniques</th>
...
<tr>
<td colspan="6"><p>Wei, J., et al. (2022). "Chain-of-Thought Prompting Elicits Reasoning in Large Language Models."</p>
<ul>
...
<tr>
<td colspan="6">Chain-of-Thought Prompting Elicits Reasoning in Large Language Models</td>
</tr>
<tr>
<td colspan="2">Core Idea</td>
<td colspan="4"><ul>
...
<tr>
<td colspan="6">Large Language Models are Zero-Shot Reasoners</td>
</tr>
<tr>
...
<li><p><img src="generated_media\DATA790_week02_notes\media\image1.jpeg" style="width:4.79167in;height:3.59375in" />can lead to wrong or vague answers on complex tasks</p></li>
</ul></li>
</ul>
<p>ChatGPT 5.6 Sol</p>
...
<tr>
<td colspan="2">Main Conceptual Takeaways</td>
<td colspan="4"><ul>
...
<tr>
<td colspan="6">Least-to-Most Prompting Enables Complex Reasoning in Large Language Models</td>
</tr>
<tr>
<td colspan="2">Core Idea</td>
<td colspan="4"><ul>
...
<tr>
<td colspan="2">Basic Structure</td>
<td colspan="4"><p><strong>Chain-of-thought.</strong></p>
<ul>
...
<p><img src="generated_media\DATA790_week02_notes\media\image2.jpeg" style="width:4.6875in;height:3.51528in" /><strong>Least-to-most prompting.</strong></p>
<p>ChatGPT 5.6 Sol</p>
<ul>
...
<tr>
<td colspan="6">Async</td>
</tr>
<tr>
<td colspan="6">Zero-Shot, Few-Shot, and Chain-of-Thought</td>
</tr>
<tr>
<td colspan="2">Zero-Shot Prompting</td>
<td colspan="4"><p>Asks the model to perform a task without giving it any examples.</p>
<ul>
<li><p>example:</p>
<ul>
...
<tr>
<td colspan="2">Few-Shot Prompting</td>
<td colspan="4"><p><strong>Gives the model a small number of examples before asking it to perform the new task.</strong></p>
<ul>
...
<tr>
<td colspan="2">Chain-of-Thought Prompting</td>
<td colspan="4"><p><strong>Encourages the model to produce intermediate reasoning steps before reaching an answer.</strong></p>
<ul>
...
<tr>
<td colspan="2">Choosing a Prompting Strategy</td>
<td colspan="4"><p><strong>Use zero-shot when:</strong></p>
<ul>
...
<tr>
<td>Main Takeaway</td>
<td colspan="5"><p><strong>Prompting is a way of controlling how much structure and guidance a language model receives.</strong></p>
<ul>
...
<tr>
<td colspan="6">Emotion Prompts and Structured Prompting</td>
</tr>
<tr>
<td>Emotional Priming</td>
<td colspan="5"><p><strong>Adds emotional or psychological language to a prompt in order to influence how the model responds.</strong></p>
<ul>
<li><p>examples:</p>
<ul>
...
<td colspan="5"><p><strong>The model itself does not need to experience emotion for emotional language to affect its output.</strong></p>
<ul>
...
<thead>
<tr>
<th>Emotional Priming can Signal Task Importance</th>
<th><ul>
<li><p>compare:</p>
<ul>
...
<p>The broader idea is that prompt wording changes the context from which the model predicts its response.</p></th>
</tr>
</thead>
<tbody>
<tr>
<td>Structured Output Prompting</td>
<td><p><strong>Tells the model exactly how its response should be organized.</strong></p>
<ul>
...
<p><strong>This is particularly important when model output will be consumed by software rather than directly by a human.</strong></p></td>
</tr>
</tbody>
</table>
...
<tr>
<th>JSON Mode</th>
<th colspan="2"><p>A particularly useful structured-output technique is requiring the model to return valid JSON.</p>
<p><img src="generated_media\DATA790_week02_notes\media\image3.png" style="width:2.26073in;height:1.31268in" /></p>
<ul>
...
<p>Instead of extracting information from prose, the application can directly access defined fields.</p>
<ul>
...
<td colspan="2"><p><strong>Assigns the model a particular persona, profession, or perspective.</strong></p>
<ul>
<li><p>examples:</p>
<ul>
...
<p><strong>Role prompting works because the training data contains many examples of different professional and social forms of communication.</strong></p></td>
</tr>
<tr>
...
<tr>
<td>Main Takeaway</td>
<td colspan="2"><p><strong>Advanced prompting is not only about telling an LLM what task to perform.</strong></p>
<ul>
...
<tr>
<td colspan="3">Introduction to Prompt Injection Risks</td>
</tr>
<tr>
<td>Prompt Injection</td>
<td colspan="2"><p><strong>Attempts to manipulate an LLM into ignoring its intended instructions.</strong></p>
<ul>
<li><p>the attacker tries to make the model:</p>
<ul>
<li><p>reveal restricted information</p></li>
<li><p><img src="generated_media\DATA790_week02_notes\media\image4.png" style="width:4.62153in;height:3.11944in" />ignore rules</p></li>
</ul></li>
</ul>
<p>ChatGPT 5.6 Sol</p>
<ul>
...
<p><strong>This can make attacks more difficult to detect because malicious instructions may be distributed across several sources.</strong></p></td>
</tr>
<tr>
<td>Defense strategy: Input and Output Filtering</td>
<td colspan="2"><p><strong>Input filtering.</strong></p>
<ul>
...
<li><p><img src="generated_media\DATA790_week02_notes\media\image5.jpeg" style="width:4.72917in;height:3.27083in" />explicit separators</p></li>
</ul></li>
</ul>
<p>ChatGPT 5.6 Sol</p></td>
</tr>
<tr>
<td colspan="2">Defense Strategy: Monitoring and Auditing</td>
<td><ul>
...
<p><span class="math display"><strong>↓</strong></span></p>
<p><span class="math display"><strong>r</strong><strong>e</strong><strong>v</strong><strong>i</strong><strong>e</strong><strong>w</strong> <strong>o</strong><strong>r</strong> <strong>b</strong><strong>l</strong><strong>o</strong><strong>c</strong><strong>k</strong></span></p></td>
</tr>
<tr>
<td colspan="2">Input Sanitization</td>
<td><p><strong>Modifies or rejects potentially dangerous input before it reaches the mode.</strong></p>
<ul>
...
<tr>
<td colspan="2">No Single Defense is Sufficient</td>
<td><p><strong>The strongest approach is defense in depth.</strong></p>
<ul>
