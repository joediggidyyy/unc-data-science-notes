...
<thead>
<tr>
<th>Metrics And Error Costs</th>
<th><p>Choosing an evaluation metric is not only a technical decision; metrics should represent the practical cost of incorrect predictions.</p>
<p>Health care diagnosis:</p>
<ul>
...
<p>The appropriate metric depends on the application's objectives and the relative cost of each type of error.</p></th>
</tr>
</thead>
<tbody>
<tr>
